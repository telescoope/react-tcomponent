...
import { isEmpty, isUndefined, filter, isEqual, isArray, isString, find, isNull, includes, debounce, uniqBy, findIndex, isBoolean, uniq, map, isObject } from 'lodash';
...
import { Input, ButtonGroup, Button, Modal, ModalHeader, ModalBody, InputGroup, InputGroupAddon, InputGroupText, Table, Row, Col, Tooltip, FormGroup, Label, Dropdown, DropdownToggle, DropdownMenu, DropdownItem, Badge, Card, CardBody, CardTitle, CardText } from 'reactstrap';
...
var InputText = /*#__PURE__*/function (_React$Component2) {
  ...
  _proto2.render = function render() {
    ...
    if (this.props.disabled || this.props.isReadonly) {
      ...
      return /*#__PURE__*/React.createElement(SunEditor, {
...
function InputFile(props) {
  ...
  return /*#__PURE__*/React.createElement("div", null, !loading && !props.isReadonly && /*#__PURE__*/React.createElement("div", null, !props.isMultiple && /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      icon: faDownload
    }), " Unduh"), !props.isReadonly && /*#__PURE__*/React.createElement(Button, {
      color: "danger",
      onClick: function onClick() {
        return onDelete(val);
      },
      ...
      icon: faTimes
    }), " Hapus")), /*#__PURE__*/React.createElement(Modal, {
      size: "lg",
      id: 'modal_' + val,
      isOpen: open[val],
    ...
    }, "Lampiran ", val), /*#__PURE__*/React.createElement(ModalBody, null, /*#__PURE__*/React.createElement(Preview, {
      key: val,
      type: type[val],
      file: val
    }))));
        ...
        try {
          if (_this.props.isMultiple) {
            ...
            if (_this.props.value) {
              ...
              val = findArrayName(_this.props.name, _this.props.input) || null;
            }
...
function DataTableContainer(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    icon: faFile
  }), " \xA0 Hal :", ' ')), /*#__PURE__*/React.createElement(Input, {
    style: {
      borderLeft: 'none',
      borderRight: 'none',
      minWidth: 72
    ...
    icon: faColumns
  }), " \xA0 Lihat :", ' ')), /*#__PURE__*/React.createElement(Input, {
    type: "number",
    min: 1,
    style: {
      borderLeft: 'none',
    ...
    }, /*#__PURE__*/React.createElement("tr", null, row.cells.map(function (cell) {
...
function DataTable(props) {
  ...
  return /*#__PURE__*/React.createElement(MyLoadingOvelay, {
    ...
    md: "8",
    lg: "8"
  }, /*#__PURE__*/React.createElement("div", null, props.renderFilter ? props.renderFilter : null))), /*#__PURE__*/React.createElement(Row, {
    style: {
    ...
    md: "4",
    lg: "4"
  }, /*#__PURE__*/React.createElement("div", null, props.isSearchable && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(InputGroup, null, /*#__PURE__*/React.createElement(InputGroupAddon, {
    style: {
      borderRight: 'none'
    },
    addonType: "prepend"
    ...
    type: "text"
  }, _React$createElement["id"] = slug('keyword_' + key_select), _React$createElement.name = "keyword", _React$createElement.placeholder = "Pencarian", _React$createElement)), /*#__PURE__*/React.createElement(InputGroupAddon, {
    addonType: "append"
  }, /*#__PURE__*/React.createElement(Button, {
    style: {
      zIndex: 0
  ...
  }))), (props["export"] || props["import"]) && /*#__PURE__*/React.createElement(InputGroupAddon, {
    addonType: "append"
  }, props["export"] && /*#__PURE__*/React.createElement(Button, {
    id: "exportFile",
    style: {
      zIndex: 0
    },
    ...
    target: "exportFile",
    toggle: toggleExport
  }, "Export")), props["import"] && /*#__PURE__*/React.createElement(Button, {
    id: "importFile",
    style: {
      zIndex: 0
    },
...
var InputSelect = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    if (this.props.withModal) return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Row, null, !this.props.isReadonly && /*#__PURE__*/React.createElement(Col, {
      ...
      toggle: this.openModal
    }, this.props.placeholder || 'Pilih'), /*#__PURE__*/React.createElement(ModalBody, null, /*#__PURE__*/React.createElement(Select, {
      isClearable: true,
...
function InputWorkflow(props) {
  ...
  return /*#__PURE__*/React.createElement(MyLoadingOvelay, {
    ...
    tag: "h5"
  }, activity.activity.name || 'Alur tidak ditemukan'), /*#__PURE__*/React.createElement(CardText, null, !readonly && /*#__PURE__*/React.createElement(Row, null, /*#__PURE__*/React.createElement(Col, {
    lg: "6"
  }, /*#__PURE__*/React.createElement(FormGroup, {
    row: true
  }, /*#__PURE__*/React.createElement(Col, {
    lg: "3"
  }, /*#__PURE__*/React.createElement(Label, null, "Respon ", /*#__PURE__*/React.createElement("span", {
    className: "text-danger"
  }, "*"))), /*#__PURE__*/React.createElement(Col, {
    lg: "9"
    ...
    lg: "3"
  }, /*#__PURE__*/React.createElement(Label, null, "Lampiran")), /*#__PURE__*/React.createElement(Col, {
    lg: "5"
  ...
  }, /*#__PURE__*/React.createElement(Label, null, "Komentar")), /*#__PURE__*/React.createElement(Col, {
    lg: "9"
    ...
    onClick: cancel
  }, "Kembali"), !readonly && /*#__PURE__*/React.createElement("button", {
    type: "button",
...
var Main = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, this.state.open ? /*#__PURE__*/React.createElement("div", {
      ...
      onClick: this.toggle,
      type: "button"
    }, "Pilih")) : /*#__PURE__*/React.createElement(Button, {
      style: {
        zIndex: 0,
        backgroundColor: val,
        border: 0
...
function ShowData(props) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, val && !isUndefined(val) && !isEmpty(val) ? [labelGenerate(val), !props.isReadonly && /*#__PURE__*/React.createElement(Button, {
    color: "link",
...
function InputSelectFetch(props) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ref: nodeRef
  }, /*#__PURE__*/React.createElement(Row, null, !props.isReadonly && /*#__PURE__*/React.createElement(Col, {
    lg: "2",
    md: "2",
    sm: "4",
    xs: "12"
    ...
    toggle: openModal
  }, props.placeholder || 'Pilih'), /*#__PURE__*/React.createElement(ModalBody, null, /*#__PURE__*/React.createElement(MyLoadingOvelay, {
    isLoading: listLoading
